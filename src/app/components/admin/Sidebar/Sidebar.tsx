...
import { BsBoxSeam, BsClipboardCheck, BsSpeedometer2, BsTags } from "react-icons/bs";
      ...
      {state.load ? state.load : <>
        ...
        >
          ...
          <Link
            ...
            className={`group  a h-11 p-3 flex gap-3 hover:pl-7 hover:bg-white ${pathname.startsWith("/admin/voucher") ? "pl-7 bg-white" : ""
              } transition-all duration-300	rounded-md cursor-pointer select-none`}
          >
            <BsTags
