...
import Statususer from "@/pages/E-admin/Components/Status";
            ...
            <div className="flex items-center border p-4 rounded shadow">
              <div>
                {infouser?.avatar ? (
                  ...
                  <FaCircleUser className="w-24 h-24 rounded-lg shadow-lg text-gray-800" />
                )}
              </div>
          ...
          <div className="w-full h-full overflow-y-scroll flex flex-col gap-4">
            {orderdetail.length === 0 ? (
              <div className="flex justify-center items-center h-full">
                <div className="text-center text-gray-500 text-3xl py-4">Không có đơn hàng</div>
              </div>
            ) : (
